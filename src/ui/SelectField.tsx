...
import { ValidationSchemaTypes } from "../lib/types";
  ...
  return (
    <div className="space-y-3 w-full">
      ...
      <select
        ...
        className="select select-bordered focus:bg-white bg-gray-200 dark:bg-slate-600 dark:focus:bg-slate-950 w-full pr-1"
      >
        {options.map((option) => (
