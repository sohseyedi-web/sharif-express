  ...
  return (
    <>
      ...
      <aside
        ...
        } fixed z-50 lg:relative lg:bg-transparent dark:lg:bg-transparent bg-gray-200 dark:bg-gray-800 h-screen lg:h-auto border-l-2 dark:border-gray-900 py-4 px-2 space-y-3 transition-all duration-300`}
      >
